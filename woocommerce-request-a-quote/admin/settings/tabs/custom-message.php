...
add_settings_section(
	...
	esc_html__( 'Custom Messages', 'addify_acr' ),   // Title to be displayed on the administration page.
...
add_settings_field(
	...
	esc_html__( 'Quote Submitted successfully Message', 'addify_acr' ),    // The label to the left of the option interface element.
	...
	array( esc_html__( 'This message will appear on quote submission page, when user submit quote.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'View Quote Basket Button Text', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_view_button_message_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_messages_section',                          // The page on which this option will be displayed.
	'afrfq-message-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'This text will be shown for view quote basket button.', 'addify_acr' ) )
);
