...
add_settings_field(
	...
	esc_html__( 'Enable (Out of stock)', 'addify_acr' ),    // The label to the left of the option interface element.
	...
	array( esc_html__( 'Enable/Disable request a quote button for out of stock products. (Note: It is compatible with simple and variable products only', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Quote Basket Menu(s)', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_quote_menu_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Select Menu where you want to show Mini quote Basket. If there is no menu then you have to create menu in WordPress menus otherwise mini quote basket will not show.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Disable quote basket for user roles', 'addify_adcod' ),    // The label to the left of the option interface element.
	'afrfq_customer_roles_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Disable quote basket for user roles. Enable for all user roles by default.', 'addify_adcod' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Quote Basket Style', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_basket_option_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Select to show drop down or icon with number of items in Basket.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Enable Ajax add to Quote (Product Page)', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_enable_ajax_product_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Enable/Disable Ajax add to quote on product page.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Enable Ajax add to Quote (Shop Page)', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_enable_ajax_shop_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Enable/Disable Ajax add to quote on shop page.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Redirect to Quote Page', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_redirect_to_quote_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Redirect to quote page after a product added to quote successfully.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Redirect after Quote Submission', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_redirect_after_submission_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Redirect to any page after quote is submitted successfully.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'URL to Redirect', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_redirect_url_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'URL to redirect after quote is submitted successfully.', 'addify_acr' ) )
);
