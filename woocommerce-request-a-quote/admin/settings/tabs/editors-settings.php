...
add_settings_section(
	...
	esc_html__( 'Editors & Builders Settings', 'addify_acr' ),   // Title to be displayed on the administration page.
...
add_settings_field(
	...
	esc_html__( 'Elementor Compatibility', 'addify_acr' ),    // The label to the left of the option interface element.
	...
	array( esc_html__( 'Enable Elementor compatibility', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Divi Builder Compatibility', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_enable_divi_compt_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_editors_section',                          // The page on which this option will be displayed.
	'afrfq-editors-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Enable Divi Builder Compatibility.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Solution 2', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_enable_solution2_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_editors_section',                          // The page on which this option will be displayed.
	'afrfq-editors-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Enable another solution if your add to cart is not replaced by plugin Button.', 'addify_acr' ) )
);
