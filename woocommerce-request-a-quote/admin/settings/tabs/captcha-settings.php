...
add_settings_section(
	...
	esc_html__( 'Google Captcha Settings', 'addify_acr' ),   // Title to be displayed on the administration page.
...
add_settings_field(
	...
	esc_html__( 'Enable Captcha', 'addify_acr' ),    // The label to the left of the option interface element.
	...
	array( esc_html__( 'Enable Google reCaptcha field on the Request a Quote Form.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Site Key', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_site_key_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_captcha_section',                          // The page on which this option will be displayed.
	'afrfq-captcha-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'This is Google reCaptcha site key, you can get this from Google. Without this key Google reCaptcha will not work.', 'addify_acr' ) )
);
...
add_settings_field(
	...
	esc_html__( 'Secret Key', 'addify_acr' ),    // The label to the left of the option interface element.
	'afrfq_secret_key_callback',   // The name of the function responsible for rendering the option interface.
	'afrfq_captcha_section',                          // The page on which this option will be displayed.
	'afrfq-captcha-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'This is Google reCaptcha secret key, you can get this from google. Without this key google reCaptcha will not work.', 'addify_acr' ) )
);
