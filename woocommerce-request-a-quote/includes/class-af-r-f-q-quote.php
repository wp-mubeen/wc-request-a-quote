...
class AF_R_F_Q_Quote {
	...
	public function get_product_price( $product ) {
		...
		return apply_filters( 'addify_quote_product_price', wc_price( $product_price ), $product );
	}
	 ...
	 */
	public function add_to_quote( $product_id = 0, $quantity = 1, $variation_id = 0, $variation = array(), $quote_item_data = array(), $return_contents = false ) {
		try {
			...
			$quote_item_data = (array) apply_filters( 'addify_add_quote_item_data', $quote_item_data, $product_id, $variation_id, $quantity );
