...
class AF_R_F_Q_PDF_Controller {
	...
	public function get_header( $quote_id ) {
		...
		if ( file_exists( get_template_directory() . '/woocommerce/addify/pdf/pdf-header.php' ) ) {

			include get_template_directory() . '/woocommerce/addify/pdf/pdf-header.php';
	...
	public function add_customer_info_table( $quote_id ) {
		...
		if ( file_exists( get_template_directory() . '/woocommerce/addify/pdf/customer-info.php' ) ) {

			include get_template_directory() . '/woocommerce/addify/pdf/customer-info.php';
	...
	public function add_quote_contents_table( $quote_id ) {
		...
		if ( file_exists( get_template_directory() . '/woocommerce/addify/pdf/quote-contents.php' ) ) {

			include get_template_directory() . '/woocommerce/addify/pdf/quote-contents.php';
